...
# Swap columns if needed - you may need to adjust this based on your K=3 results
# For now keeping original order, but you can reorder like: Q = Q[[1, 0, 2]]
Q = Q[[1, 0, 2]]  # Southern (red), Northern (blue), New component (gold)
Q.columns = [0, 1, 2]
