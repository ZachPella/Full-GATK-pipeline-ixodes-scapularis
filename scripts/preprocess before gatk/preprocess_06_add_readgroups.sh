...
SAMPLE_LIST="${BASEDIR}/scripts/sample_list.txt"
...
# Input is the downsampled BAM file
INPUT_BAM="${INPUTDIR}/${SAMPLE}.downsampled.sorted.bam"
...
# RGLB (Library) and RGPU (Platform Unit) are set to SAMPLE for consistency
