...
# Set directories
BASE_DIR="/work/fauverlab/zachpella/scatter_20/QC_alignment_preprocessing_haplotype/SD_and_BEI_2025_fasta"
OUTPUT_DIR="/work/fauverlab/zachpella/scatter_20/QC_alignment_preprocessing_haplotype/concatenated_reads"
SAMPLE_LIST="/work/fauverlab/zachpella/scatter_20/QC_alignment_preprocessing_haplotype/sample_list.txt"
