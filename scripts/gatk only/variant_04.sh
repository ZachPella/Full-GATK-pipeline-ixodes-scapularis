...
WORKDIR=${BASEDIR}/downsampled_our_data_and_online/genotyping
...
FINAL_OUTPUT_DIR=${BASEDIR}/downsampled_our_data_and_online/final_vcf
...
# Prepare Input File List (Gather setup)
...
echo "Found $(echo ${INPUT_VCFS} | wc -w) VCF chunks to gather."

# Run GATK GatherVcfs (Merge)
...
# Run GATK IndexFeatureFile (Index Creation)
